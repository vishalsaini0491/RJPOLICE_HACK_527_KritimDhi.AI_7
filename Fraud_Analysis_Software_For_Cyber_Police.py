...
def about_section():
    ...
    team_members = [
        {"name": "Vishal Saini", "role": "B.Tech 3rd Year CSE", "college": "JECRC College",
         "image_url": r"./2.png"},
        {"name": "Akansha Goyal", "role": "2nd Year AI&DS", "college": "JECRC College",
         "image_url":r"./1.png"},
    ]
...
def main():
    ...
    st.markdown(
        """
        <iframe title="hack" width="1568" height="744" 
